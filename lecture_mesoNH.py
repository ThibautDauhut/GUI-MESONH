                        ...
                        for param in params:
                            if param not in data_mnh[today_str][model]:
                                ...
                                if param == "tmp_2m":
                                    ...
                                    D = (100000 / P)**(2 / 7)
                                    data_mnh[today_str][model][param] = (
                                        f[groupMEAN].variables['MEAN_TH'][:, 2] / D) - 273.15

                                if param == "tmp_10m":
                                    P = f[groupMEAN].variables['MEAN_PRE'][:, 5]
                                    D = (100000 / P)**(2 / 7)
                                    data_mnh[today_str][model][param] = (
                                        f[groupMEAN].variables['MEAN_TH'][:, 5] / D) - 273.15
                                if param == "hum_rel":
                    ...
                    if param not in data_user[today_str]:
                        ...
                        if param == "flx_chaleur_lat":
                            data_user[today_str][param] = f[groupSURF].variables['E0'][:] * \
                                f.variables['RHODREF'][2] * 2400000  # TODO facteur a corriger
                        if param == "LWU":
